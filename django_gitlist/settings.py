"""
Django settings for django_gitlist project.
...
SECRET_KEY = '(2@hqx_j$+cs9(9tjig#)$@k#xotj6ux69+c#!ilsfnh9ow3zg'
...
ROOT_URLCONF = 'django_gitlist.urls'

WSGI_APPLICATION = 'django_gitlist.wsgi.application'
